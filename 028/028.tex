...
\vishaya{`AtamxneYvAyaM joyxVtiSa{\rm --}' itAyxdi maMtarxda athaR vaNaRneya upasaMhAra}
%%% footnote shloka
\begin{artha}
...
\vishaya{deVhAtamxvAdiyu idanunx dUSisuvudu{\rm --}}
\begin{artha}
...
\vishaya{I varegU anumAna (takaR) eMbudakekx pArxmANayxvanunx opipx heVLidadxrU deVhAtamxvAdiyu anumAnavu parxmANaveV alalxveMdu heVLuvanu{\rm --}}
\begin{artha}
