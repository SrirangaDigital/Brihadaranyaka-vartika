...
savxBAvAnenxYva saMsidheyxVdavxsutxnoV\s vayxBicAritA \hfill||  752 ||  
\end{shl}
...
vayxBicArAcaCxrAcaCxqqknAgxcaCxrasoyxVtapxtitxriVkaSxyXteV \hfill||  756 ||  
\end{shl}
...
akAyaRshAcxsavxBAvashacx nAliknagxM kaqtitxkoVdayaH \hfill||  759 ||  
\end{shl}
...
shabAdxthARroVpaNeVneYva savikalapxdhiyoV janiH \hfill||  772 ||  
\end{shl}
...
savxBAvoV vA\s thavA kAyaRM vikalopxV\s yaM matoV yataH \hfill||  774 ||  
\end{shl}
...
yathoVkatxnAyxyamAgeVRNa savxBAvAdi tataH kutaH\hfill ||  805 ||  
\end{shl}
...
devxV EveVti, na saMdhayxtAvxtasxvXpanxsayx sAthxnayoVdavxRyoVH \hfill||  836 ||  
\end{shl}
...
na sAthxnAnatxranidadxnuteyxY yatUtxkatxmavadhAraNamf \hfill||  837 ||  
\end{shl}
...
AkarxmaH sa yathA yasayx soV\s yamAtAmx yathAkarxmaH\hfill ||  848 ||  
\end{shl}
