...
nirUpaNe EtakAkxgi~? eMdare  \mdash }
...
\begin{artha}
yAvudara upAdhigaLanunx niSeVdhisuva neVti neVti eMba vacanadiMda barxhamxda tatatxvXvanunx sapxSaTxvAgi horapaDisabeVkeMdu udedxVshisideyo, adanunx Iga\break heVLuvudu.
\end{artha}
...
\vishaya{barxhamxda soVpAdhika savxrUpa  \mdash }
...
\vishaya{parxmANaveMba beVre rUpavideyeMdare -utatxra \mdash }
...
\vishaya{aMtayARmi muMtAda beVre rUpavilalxve~? eMdare  \mdash }
...
\vishaya{hAgAdare tatatxvXvu tiLiyuvudu heVge~? eMdare  \mdash }
...
\vishaya{`vAva' eMbuva nipAtada athaR  \mdash }
...
adevxYtakekx hAniyalalxve~? eMdare  \mdash }
...
\vishaya{matayxR shabadxda athaR  \mdash }
...
\vishaya{idaraMte amUtaRvanunx tiLiyabeVku  \mdash }
...
\vishaya{tadeVtanUmxtaRmf' eMbudara athaR  \mdash }
...
\vishaya{mUtaR itAyxdigaLa athaR  \mdash }
...
\vishaya{`tasayx Etasayx' itAyxdi vAkayxgaLige athaR  \mdash }
...
\vishaya{``ya ESa tapati'' eMbudara athaRveVnu~?}
...
\vishaya{teVjasisxge rUpasaqSiTxyalilx pArxdhAnayx heVge~? eMdare  \mdash }
...
\begin{artha}
I sUyaRmaMDalada maneyalelx IshavxranAda deVvadeVva virATf puruSana karaNavu (samaSiTxliMga shariVravu) AsharxyisikoMDide eMbudanunx Iga ililx\break heVLuvudu.
\end{artha}
...
\vishaya{I viSayadalilx BataqR parxpaMcara mata hiVgide  \mdash }
...
\vishaya{adu Eke samAnavalalx~? eMdare  \mdash }
...
\vishaya{IshavxraneV kAraNaveMbudU saha paramAthaRvalalx  \mdash }
...
\vishaya{elilx parxyoVgavu kaMDide~? eMdare  \mdash }
...
\vishaya{adhideYvata-adhAyxtamxveMbudara vAyxKAyxna  \mdash }
...
\vishaya{adakekx parxmANavanunx toVrisutAtxre  \mdash }
...
\vishaya{amUtaR lakaSxNaviruva sathxLa yAvudu~?  \mdash }
...
\vishaya{BataqRparxpaMcara matoVpasaMhAra}
...
\vishaya{matutx takaRdiMdalU visheVSavanunx Uhisabahudu  \mdash }
...
\vishaya{vijAcnxnavAdigaLa BarxmeyU idakekx AdhAravAgide  \mdash }
...
\vishaya{avara  BArxMti heVgideyeMdare  \mdash }
...
\vishaya{sAMKayxra Barxmeyanunx heVLuvaru  \mdash }
...
\begin{artha}
veVdAMta athaRvanunx tiLiyade kelavaru upaniSatitxna tatatxvXvanunx tiLidiruveveMba aBimAnashAligaLAgi bahaLa nipuNateyiMda parxkirxyeyanunx kalipxsi\break heVLuvaru.
\end{artha}
...
tayxtf eMdU\break heVLalapxDuvavu.
\end{artha}

\vishaya{paMcaBUtagaLu satatxyX eMbudu heVge `pArxNAveY satayxmf' eMdalalxve heVLide~? eMdu keVLidare - utatxra  \mdash }
...
\vishaya{vAsaneyu Atamxnige BinenxYsideyeMdare - adakekx utatxra  \mdash }
...
\vishaya{adanenx muMde sapxSaTxpaDisutAtxre  \mdash }
...
\vishaya{paramAtamxna aMshaveV liMgashariVrayukatxveMdu heVLalilalxve~? eMdare -}
...
heVLidadxnunx\break nirAkarisutAtxre  \mdash }
...
vasutxvina jate seVrisidare tapepxVnu~? eMdare  \mdash }
...
\vishaya{jiVvana mUlaka vAsanegaLu paramAtamxnalilx heVge seVruvavu?  \mdash }
...
\begin{artha}
``veyxVva tAvx jacnxpayiSAyxmi'' (2-1-15) eMdu mADida parxtijecnxge\break
...
sAkiSxyalilx heVge toVruvavu~?  \mdash }
...
\vishaya{I riVtiyAgi rAgAdi vAsanegaLu ErupeVrAgi iruvudakekx kAraNavanunx\break
tiLisutAtxre  \mdash }
...
\vishaya{idakekx udAharaNe muMdinadeV  \mdash }
...
\vishaya{hiraNayxgaBaRna upAsaneya mahime  \mdash }
...
mitavAgive eMba BArxMtiyanunx hoVgalADisutAtxre  \mdash }
...
\vishaya{shurxtiya AdeVsha shabadxda athaR  \mdash }
...
sadivxtiVyanAguvalilx Enu utatxra eMdare  \mdash }
...
irabahudaSeTx~? eMdu keVLidare utatxra  \mdash }
...
adanunx\break beVpaRDisutAtxre  \mdash }
...
\vishaya{hAgAdare nacnf padavu nilulxvudu yAvAga eMdare  \mdash }
...
\vishaya{barxhamxniSeThxyu avashayx beVkAgide - EkeMdare  \mdash }
...
muMde huTaTxbahudaSeTx eMdare, ilalx  \mdash }
...
\vishaya{viVpesx (elalx) eMbathaRveMba pakaSxda upasaMhAra  \mdash }
...
heVLidadxlilx Enu hAni~? eMdare  \mdash }
...
\vishaya{eraDu pakaSxdalUlx doVSagaLivu barutatxve  \mdash }
...
\vishaya{parasapxra vayxBicaritaveMbudu heVge~? eMdare  \mdash }
...
anuBavasidadhxvAgidadxre Eke satayxvalalx~? eMdare  \mdash }
...
\vishaya{Atamxnu savxtaH parxkAshaneMbudu heVge~? eMdare  \mdash }
...
\vishaya{nacnaf padada athaRvu parxtayxgAtamxna athaRvanunx lakiSxsuvudu
(tiLisuvudu) - heVgeMdare  \mdash }
...
\vishaya{parxtayxkASxdigaLa baladiMdale parxtayxgAtamxnu sididhxsuvAga nacnf
padAthaRdiMda Eke lakiSxsabeVku~? eMdare  \mdash }
\vskip 2pt
\begin{shl}
...
\vishaya{idakekx samAdhAnavanunx heVLutAtxre  \mdash }
...
\begin{artha}
shabAdxthaRgaLa saMbaMdhavilalxdidadxrU akaSxradalilx (barxhamxnalilx) aMgiVkarisi\break (meVlina) upadeVshagaLu (baMdive) vasutxtaH I barxhamxnalilx oMdu shabadxvU\break iruvudilalx.
\end{artha}
...
\vishaya{``satayxsayxsatayxM pArxNAveY satayxM teVSAmeVSa satayxM"
  eMbalilx satayx padAthaR  \mdash }
...
nAmagaLiMda vayxvaharisuvuduMTalalxve? eMdare - samAdhAna  \mdash }
