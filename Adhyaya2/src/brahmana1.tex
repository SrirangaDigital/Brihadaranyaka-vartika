...
eMdu\break parxshinxsidare  \mdash }
...
\begin{kandikeshl}
sa hoVvAca gAgoyxVR ya EvAyaM yanatxM pashAcxcaCxbodxV\s nUdeVteyxV\-tameVvAhaM barxhomxVpAsa iti sa hoVvAcAjAtashaturxmAR meYtasimxnasxM\-vadiSAThx asuriti vA ahameVtamupAsa iti sa ya EtameVvamupAsetxV savaRM heYvAsimxMlolxVka AyureVti neYnaM purA kAlAtApxrXNoV\break ja\null{hA}ti ||~10~||
\end{kandikeshl}
...
divxtiVya, anapaga eMdu eraDu visheVSaNagaLu heVLalapxTiTxve. (11neV kaMDikeyalilx) avugaLa\break athaRveVneMdare  \mdash }
...
\begin{artha}
yAvudariMda ecacxrisalapxTaTxvanAdarU malagidavanu ecacxrAgaleV ilalxvo adariMda gAgayxRnige saMmatavAda pArxNavu BoVkatxnalalx (Atamxnalalx)veMdu\break tiLiyitu.
\end{artha} 
...
\begin{artha}
parxshenx \ndash  hiMde AditAyxdi deVvategaLanunx A pArxNavasutxvige beVreyAgi heVLalilalxve? hiVgiruvAga deVvatA viSayadalilx iruva BeVdavanunx heVge\break nirAkarisuvudu?.
...
Aguvudu.\footnote{``gAmAnaya'' (goVvanunx tegedukoMDu bA) eMbuva  shabadx parxyoVga mADuvudu tanagAgiyoV, athavA inonxbabxrigAgiyoV? eMdu parxshinxsidare, tanagAgiyeMdu heVLuvudakekx Aguvudilalx. tananx vacanadiMda tanage hosa viSayavu tiLiyuvudilalx, inonxbabxrigAgi eMdu heVLidarU vayxthaR. I mAtiniMda matotxbabxnige athaRjAcnxnavAguvudeMbudU saha parxtayxkaSxvAguvudilalxvAdadxriMda vayxthaRveMdu tAtapxyaR.}
\end{artha}
...
\begin{artha}
saMvagaR vidAyxparxkaraNadalilx (``vAyuvARva saMvagaR'' ililxMda AraMBisi ``vAyuheyxVRveYtAnf savARnf saMvaqknetxV'' ililx payaRMta shurxtiyalilx) aginx muMtAdavugaLige vAyuvinalUlx vAgAdi-iMdirxyagaLige (``pArxNoVvA vAva saMvagaRH pArxNoVheyxVveYtAnf savARnf saMvaqknetxV'') pArxNadalUlx upasaMhAravanunx heVLuvudu matutx kAraNakekx beVreyAda vasutxvinalilx upasaMhAravu\break baruvudilalx.
\end{artha}
...
\vishaya{AtamxceYtanayxvu niviRkAra nitayxveMdare kataqR, BoVkatxqq eMdu vikArabudidhxyu heVge barutatxde? eMdare  \mdash }
...
\end{shl}
%~ \footnotetext[1]{paraM eMdu AnaM-TiVkAdalilx pAThAMtaravide, AvAga  barxhamxkikxMtha utakxqqSaTx, athavA nikaqSaTx vasutx  beVreyilalxveMdathaR}
%~ \footnotetext[2]{iha eMbudakekx I `AkAsheV sheVteV' eMba  shayana vAkayxdalilx eMdathaR.}
...
parxshinxsabahudeMba shaMkege samAdhAna pUvaRvAdiya mUlaka heVLiyU A samAdhAnavanunx Iga heVLuvaru  \mdash }
...
\vishaya{yoVgayxvAda deVshavu savxpanx kAladalilx 
iruvudilalxvAdadxriMdalU savxpanxvasutx\break satayxvalalx  \mdash }
...
\vishaya{``sa yathA mahArAjo jAnapadAnf" itAyxdi vAkayxda meVle shaMke\break
mADuvudu  \mdash }
...
\begin{artha}
ede hAlanunx kuDiyuva shishu heVge rAgadevxVSagaLilalxde irabalalxdo hAgeye rAgadevxVSagaLilalxvAdadxriMda citatxvanunx viSayagaLu yAvAgalU\break vikAragoLisuvudilalx.
\end{artha}
...
\begin{artha}
tananx parxjegaLu viniVtarAgiruvudariMda elAlx kaDeyalUlx taDeyilalxda\break shAsanavuLaLx rAjanu balita iMdirxyavuLaLxvanAdarU I loVkadalilx bahu suKiyAgiruvanu.
\end{artha}
...
\vishaya{taTasathx IshavxraneV kataRnAdare matotxMdariMda perxVritanAdare I doVSavu baruvudu.}
...
upajiVvisikoMDiruvudariMda savxtaMtarx PalavuLaLxdAdxgalAradu.
\end{artha}
...
satayxvasutx paramapada\footnote{`tadivxSoNxV: paramaMpadamf' eMdu shurxtiye heVLuvudu} (viSuNx padaveV) 
\end{artha}
...
\vishaya{seVshavxravAdiya AshaMke  \mdash }
...
\vishaya{`ahaMbarxhAmxsimx' eMba jAcnxnavilalxde hoVdare mukitx heVge AdiVtu eMdare  \mdash }
...
\vishaya{parabarxhamxda pariNAmave jiVva eMba mata nirAkaraNe  \mdash }
...
\vishaya{I modalina vikalapxkekx daqSATxMtavide  \mdash }
...
lakaSxNavanunx\break tiLisuvaru  \mdash }
...
\begin{artha}
beMkiyu suDuvudu itAyxdigaLu parxtayxkaSxvAgiruvaMte veVdAMta jAcnxnadiMda huTuTxva Palavu saMsArada duHKavanunx kaLeyuvudeMbudu parxtayxkaSx\break anuBavavAguvudu.
\end{artha}
...
vAkayxgaLige\break viroVdhavilalx.
\end{artha}
...
\vishaya{shurxtiyU saha muMde heVLuvadu  \mdash }
