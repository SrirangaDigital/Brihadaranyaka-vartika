...
\vishaya{adaralilx shishubArxhamxNavu modalu baralu kAraNaveVnu~?  \mdash }
...
\vishaya{adara saMkiSxpatx vAyxKAyxna  \mdash }
...
\begin{artha}
madhayxmavAda pArxNadiMda (muKayx pArxNavAyuviniMda) BakiSxsalapxTaTxdudx vAgAdi iMdirxyagaLige taqpitxyanunxMTu mADuvudu heVgeMbudanunx heVLabeVkAdudu, matutx pArxNada upaniSatutx (rahasayx)gaLeMdare yAvadeMbudanunx heVLabeVkAgide.
\end{artha}
...
madhayxmaH pArxNa satxseyxVda meVvAdhAnamidaM parxtAyxdhAnaM pArxNaH
sUthxNAnanxM dAma || 1 ||
\end{kandikeshl}
...
\vishaya{`idaM parxtAyxdhAnamf' eMbudara athaR  \mdash }
...
\vishaya{idakekx vayxtireVka parxmANa yukitxyU ideyeMdu heVLutAtxre  \mdash }
...
\vishaya{vAkukx eraDu bage heVge~? eMdare  \mdash }
...
\vishaya{``imAveVva'' itAyxdi shurxtiya tAtapxyaR  \mdash }
