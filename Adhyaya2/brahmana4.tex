...
heVLidadxnunx anuvAda mADutAtxre  \mdash }
...
lakaSxNa barabahudeMdu pakASxMtara nirAkaraNe  \mdash }
...
\vishaya{beVre oMdu aBipArxyavideyeMdu heVLutAtxre  \mdash }
...
\vishaya{beVre riVtiyalUlx bArxhamxNavu baMdideyeMdu heVLutAtxre  \mdash }
...
\vishaya{I samucacxya viSayakekx samxqqtiyU parxmANavAgide  \mdash }
...
\vishaya{kamaRgaLelalxvU ajAcnxnadiMdaleV eMbudanunx sAdhisutAtxre  \mdash }
...
\vishaya{pitaqQuNa modalAdavugaLanunx tiVrisabeVkalalxve~? eMdare  \mdash }
...
\vishaya{viSaya veYrAgayxkekx kAraNavanunx heVLutAtxre  \mdash }
...
\vishaya{samxqqtiyanunx parxmANavAgi udAharisuvaru  \mdash }
...
\vishaya{I kamaRsaMnAyxsavanunx Asharxma karxmadiMda mADuvudalalx  \mdash }
...
\vishaya{AKAyxyikeyanunx Iga AraMBisuvaru  \mdash }
...
vatAM jiVvitaM tatheYvateV jiVvitaM sAyxdamaqtatatxvXsayx tu shAsitx
vitetxVneVti || 2 ||
\end{kandikeshl}
...
\vishaya{meYterxVyi heVLuvudu  \mdash }
...
\vishaya{yAjacnxvalakxyXru I parxshenxge utatxrisuvaru  \mdash }
...
\vishaya{veYrAgayxkekx matotxMdu kAraNavU iruvudu  \mdash }
...
\vishaya{I viSayakekx anuBavaveV parxmANa  \mdash }
...
\vishaya{jAcnxnadalilx vidhiyanunx opupxva vidhivAdiya mata  \mdash }
...
\vishaya{``savaRmAtAmx'' eMbudara tAtapxyaRveVneMdare  \mdash }
...
\vishaya{I viSayakekx BASayxkArara saMmatiyU ide  \mdash }
...
\vishaya{heVge~? nAyxyavilalxveMdare  \mdash }
...
\vishaya{sharxvaNa sAdhanagaLanunx mADidalilx baruva PalaveVnu~? eMdare  \mdash }
...
\vishaya{vAdi heVLuvaMte `AtAmxvA areVdarxSaTxvayxH' eMbuvalilx meVlemxVle shabadxdiMda toVruva athaR  \mdash }
...
\vishaya{tananxnunx tAneV noVDikoLuLxvaneMdu darxSATx eMdu Eke  athaR mADabAradu~?  \mdash }
...
\vishaya{Atamx dashaRnaveMdare saMsAri jiVvatamxna dashaRnavoV~? athavA beVreyoV~? eMdare  \mdash }
...
\vishaya{AtamxjAcnxnavu puruSAdhiVnavalalxdadxriMdalU vidhiviSayavalalx udA:-}
...
\vishaya{niyamanidhi - parisaMKAyx vidhigaLU idaralilx ilalx  \mdash }
...
\vishaya{vidhi vAdiya shaMke  \mdash }
...
\vishaya{sidAdhxthaRboVdhakavAguva veVdAMtakekx sApeVkaSxtavxvilalxve~? eMdare  \mdash }
...
\vishaya{udAharaNeyiMda tiLiyabahudu  \mdash }
...
\vishaya{aMtaha jAcnxnadalUlx vidhi Eke irabAradu~? eMdare  \mdash }
...
\vishaya{ajAcnxnada nAshakUkx vidhiyu avashayxvilalx  \mdash }
...
\begin{artha}
sAdhayxveMbudU saha loVkadalelxV utapxtitx modalAgi nAlukx bageyAgideyeMbudu tiLideVyide. Adare parxmANaveMbudakekx adu yukatxvalalx, EkeMdare modaleV sidadhxvAda vasutxvanunx parxmANavu sapxSaTxvAgi tiLisuvudu, adariMda yukatxvalalx.
\end{artha}
...
\vishaya{savxrUpa jAcnxnakUkx vidhiyu beVkilalx  \mdash }
...
\vishaya{adu heVge beVre heVtuvanunx apeVkiSxsuvudilalx~? eMdare  \mdash }
...
\vishaya{oMdAvatiR huTiTxda jAcnxnavu ajAcnxna nAshakavalalx, adakAkxgi aBAyxsa vidhi beVkeMdare  \mdash }
...
\vishaya{`darxSaTxvayxH shorxVtavayxH maMtavayxH nididhAyxsitavayxH' eMbudara pAThakarxmadiMda tiLiyuva athaR  \mdash }
...
\vishaya{anAtamx vasutxgaLa jAcnxna mAtarx parxmAtaq muMtAda BeVdagaLidedx baruvudu  \mdash }
...
\vishaya{Adare AtamxjAcnxnavu hAgilalx  \mdash }
...
\begin{artha}
`nididhAyxsitavayxH' eMba nididAyxsana shabadxdiMda dhAyxnavu heVLideyeMbudAgi shaMkisa bahudAdadxriMda dhAyxnaveV athaRveMba shaMkeyanunx hoVgalADisalu `vijAcnxneVna' eMdu heVLalapxTiTxde. idariMda dhAyxnavu jAcnxnakekx sAdhanaveMbuva aMshavanunx upeVkiSxsidaMte Aguvudilalxve~? eMdare  \mdash 
\end{artha}
...
\vishaya{AtamxveMbudu anAtamxda tatavx heVge~?  \mdash }
...
\vishaya{``barxhamx taMparAdAtf itAyxdiyAgi savaRMveVda'' eMbudanunx vAyxKAyxnisuvaru  \mdash }
...
\vishaya{itara dashaRnavanunx niSeVdhisuvudakekx PalaveVneMdare  \mdash }
...
\vishaya{idakekx giVteyU AdhAravAgide  \mdash }
...
\vishaya{shurxtiya akaSxrAthaRvanunx saMkeSxVpisuvaru  \mdash }
...
\vishaya{meVlina shurxtiya vAyxKAyxnada AraMBa  \mdash }
...
\vishaya{asamayxgfdashiRyeMdareVnu~?  \mdash }
...
\vishaya{Atamxtatavxvu heVgiruvudeMdare  \mdash }
...
\vishaya{ajAcnxnadiMda pariNAmagoMDa vaqtitx jAcnxnavu kAlAdigaLige samAnavAgiruvAga vayxtAyxsakekx kAraNaveVnu~? eMdare  \mdash }
...
\vishaya{``sa yathA duMduBeV haRnayx mAnasayx'' - itAyxdi shurxtiya athaR  \mdash }
...
\vishaya{sAmAnayx visheVSagaLige BeVdaveV eMbuvadanunx anuvadisi pariharisutAtxre  {\rm  \mdash } }
...
\vishaya{parakiVyasaMmatavAda vAyxpitxyanunx nirAkarisuvaru  {\rm  \mdash } }
...
\vishaya{Iga dASATxRMtikavanunx heVLuvaru  \mdash }
...
\begin{artha}
SaSiThxV viBakitxya athaRvU saMbaMdha sAmAnayxvU iruvudilalx, EkeMdare sadavxsutxvige eraDaneya vasutxve saMBAvisuvudilalxvAdadxriMda iruvudilalx, matutx sadavxsutxvinalilx heVge (adivxtiVyatavxvU savaRsaMga shUnayxteyU iruvudo, hAgeye beVre parxmANagaLalilxde savxparxkAshavAgiruva parxtamxgAtamxnalUlx iruvudu.	)
\end{artha}
...
\vishaya{savaRkAyaRgaLigU parxtayxgAtamxnalilx karxmavAgi laya eMbudakekx BASayxkArara saMmatiyU iruvudu  \mdash }
...
\vishaya{CAMdoVgayx shurxti saMmatiyU ide  \mdash }
...
\vishaya{Iga `sa yathA AderxRYdhAgenxVH' eMbudakekx matotxMdu upAyavanunx heVLutAtxre  \mdash }
...
\vishaya{``yadaqgevxVdoV yajuveRVda'' itAyxdi maMtarxda vAyxKAyxna  \mdash }
...
\vishaya{idakekx gamakavAda liMgavanunx heVLutAtxre  \mdash }
...
\vishaya{vAyxsAdirUpadalilx barxhamxveV purANAdi kAyaRkataqR eMbudakekx daqSATxMta  \mdash }
...
\vishaya{veVdAthaRjAcnxna mUlakavAdadxriMda itihAsAdigaLu aparxmANavAgali eMdare  \mdash }
...
\vishaya{``sayathA savARsAmf'' itAyxdiyAda muMdina shurxtige saMbaMdhavanunx heVLutAtxre  \mdash }
...
\vishaya{``EvaM saveRVSAMveVdAnAM vAgeVkAyanamf'' eMbuva dASATxRMtikavu Iga muMde BataqR parxpaMcara pakaSxvanunx pUvaRpakaSxvAgiTuTx vAyxKAyxnisutAtxre  \mdash }
...
\vishaya{budidhxpUvaRka layaveMdare yAvadu~? eMdare  \mdash }
...
\vishaya{Iga paMcaBUtagaLige layavanunx heVLalu avugaLa pUvARvasethxyanunx tiLisuvaru  \mdash }
...
\vishaya{idakekx kAraNaveVnu  \mdash }
...
\vishaya{hAgAdare putArxBimAnadiMda baruva duHKavu elilx eMdare  \mdash }
...
\vishaya{BataqRparxpaMcaru heVLuvaMte viSayagaLigU jAcnxnagaLigU iMdirxyagaLalilx layaveMbudu sariyalalx - EkeMdare  \mdash }
...
\vishaya{sugaMdha, dugaRMdhaveMba viBAgagaLu heVge Adavu~? eMdare  \mdash }
...
\vishaya{elalxvU yAvudariMda perxVreVpisalapxDuvavu~? eMdare  \mdash }
...
\vishaya{I parxLayadalilxruva pArxjAcnxtamxnu budidhxvAyxpAradiMda pArxjacnxne~? athavA beVre riVtiyalilxyoV~? eMdu keVLidare  \mdash }
...
\vishaya{pArxkaqta parxLayadalilx parxshenxyoMdu  \mdash }
...
\begin{shl}
sAvxBAvikoV\s yaM parxlaya iti \footnote{``saveVRSA meVva BUtAnAM tirxvidhaH parxti saMcaraH'' neYmititxka parxlayaveMdare kalapxvu mugidoDane Aguva sakala pArxNigaLa laya. idu barxhamxneMba parxjApatiyu mADuva avAMtarada parxLaya. huTiTxda kAyaRgaLige parxkaqtiyalilx laya yeMbudu pArxkaqtika layaveMdU, jAcnxnadiMda Aguva sakala parxpaMcada laya moVkaSxveMbudu AtayxMtika layaveMdU mUru bageya layaveMdu meVlina purANa vacanadalilx heVLide.}pwrANikA jaguH |
...
\vishaya{sAvxBAvika layakUkx jAcnxnapUvaRkavAda layakUkx iruva BeVda  \mdash }
...
\vishaya{budidhxpUvaRkavAda parxLayaveMdare  \mdash }
...
\vishaya{A niVru gaTiTxyAguvudakekx kAraNaveVneMdare  \mdash }
...
\begin{artha}
tananx avayavagaLu oMdakokxMdu seVrikoMDAga adu gaTiTxyAgi KalayxveMdu heVLalapxDutatxde. A I seYMdhavada gaTiTxyu I samudarxdalilx heVge liVnavAguvudo, hAgeye  \mdash 
\end{artha}
...
\vishaya{``mahatf BUtamf'' eMba padagaLa athaR  \mdash }
...
\vishaya{parxtayxgAtamxna mahatavxrUpavu modalU idadxdedx, hosadAgi baruvudalalx  \mdash }
...
\vishaya{``ananatxmf apAramf'' eMbudara athaRvidu  \mdash }
...
tAni BUtAnayxvideyxVti \footnote{``yatarxkAyaRM parxviliVyateV tanUmxlakAraNa (mavideyxti) avidAyx BUtashabedxVna aBidhiVyateV yadAha-AcAyaR vAcasapxtiH - ``nAma rUpabiVja shakitxBUtama vAyxkaqtaMBUtasUkamxmiti parxsidadhx BUtAnAM keSxVtarx jocnxVtAthxpakatAvxnu papatetxV: - eMdu AnaMda girigaLu udAharisutAtx samasatxkAyaRhaLaliyasAthxnavAda mUlakAraNavanunx avidAyx BUta shabadhxdiMda karediruvaru, parxsidadhxvAda paMcaBUtagaLanunx ililx tegedukoMDilalx enunxtAtxre. meVlakxMDa BASayxdaMte sUkamxvAda nAmarUpagaLu kAyaR kAraNaveMbuva shariVra, iMdirxya, matutx shabadx sapxshARdi viSayagaLu I rUpavAgi pariNAmavanunx hoMdidavu. avugaLu satayx shabAdxthaRvAda paMcaBUta sUkaSxmXgaLeMdu ililx athaRvAguvudu, AnaMdagirigaLu ililx parxsidadhx BUtagaLanunx biTuTx avAyxkaqtaveMbuva BUtasUkaSxmXvanunx mUlakAraNavanunx garxhisaleVkeMdu heVLiruvaru, keVvala paMca BUtagaLige jiVvavanunx kalipxsuvudakekx bAradidadxrU avidAyx mUlakavAgi kalipxsuvudakekx sAdhayxvide, jiVvaMkalapxyateV pUvaRMtatoV BAvAnf paqthagf vidhAnf eMdu heVLidaMte jiVvakalapxtavAdadudx ajAcnxta mUlaceYtanayx. (athavA adara mUlAjAcnxnaveMdu heVLuvudakekx aDiDxyeVnU ilalx, idu avidAyx rUpaveMdu heVLi BUtagaLige jiVvakalapxkatavxvanunx vAtiRkarArarU heVLiye idAdxre, BASayx vAtiRkAnusAravAgi nAvu avidAyxmayavAda shariVreVMdirxyAkAravAgi pariNamisuva sUkaSxmX BUtagaLanunx ililx tegedukoLaLxbeVkeMdu nanage toVrutatxde. vidAvxMsaru vimAshiRsabeVku.)}pArxhusatxrXyayxnatxniSiThxtAH \hfill  || 418 ||
\end{shl}
...
\begin{artha}
elalxvU I riVtiyAgi edudxkoLuLxvudu ajAcnxnada nimitatxvAgiyeV, A  ajAcnxnavU `naveVdimx' (nAnu tiLidilalx)veMdu heVLuva agarxhaNa rUpavAdadudx, adu BArxMti jAcnxnavanunxMTumADutAtx I bageyAgiye A nAnArUpagaLanunxMTumADuvudu.
\end{artha}
...
\begin{kandikeshl}
sA hoVvAca meYterxVyayxterxYva mA BagavAnamUmuhananx perxVtayx saMjAcnxsitxVti sa hoVvAca na vA areV\s haM moVhaM barxviVmayxlaM vA ara idaM vijAcnxnAya || 13 ||
\end{kandikeshl}
...
\begin{artha}
kAyaRkAraNagaLu nashisidarU savxtaH sidadhxvAgi beVroMdu parxmANagaLilalxde yAvudu savx parxkAshavAgiruvado, A vasutxvu savxsavxrUpavanunx inonxMdara apeVkeSxye ilalxde beLagalu samathaRvAgiruvadu.
\end{artha}

\kandike{kaMDike 14}

\begin{kandikeshl}
yatarx hi devxYtamiva Bavati taditara itaraM jiGarxti taditara itaraM pashayxti taditara itaraM shaqNoVti taditara itaramaBivadati taditara itaraM manuteV maditara itaraM vijAnAti yatarx vA asayx savaRmAtemxYvABUtatxtekxVna kaM jiGerxVtatxtekxVna kaM pasheyxVtatxtekxVna kaM shaqNuyAtatxtekxVna kamaBivadeVtatxtekxVna kaM manivxVta tatekxVna kaM vijAniVyAtf ||yeVneVdaM savaRM vijAnAti taM keVna vijAniVyAdivxjAcnxtAramareV keVna vijAniVyAditi || 14 ||
\end{kandikeshl}
...
vAsaneyanunx tegedukoLuLxvanu beVreyAgiyeV idudx tanage beVreyeV Ada
...
\begin{shl}
vijAcnxnaGana ituyxketxVviRSayoV\s yamathoVceyxteV |
