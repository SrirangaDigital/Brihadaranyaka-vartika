...
\vishaya{puNayxkamaRda Palavanunx heVLidaMte pApada Palavanunx Eke ililx\break heVLalilalx? eMdare}
...
\vishaya{avideyxyananxlalxve saMsAravenunxvudu, hAgAdare adu kamaRPala\-\break veMbudu heVge?}
...
\begin{artha}
namage mukitxyeMbudu ajAcnxnada nAsha, adakekx kamaRsAdhanavalalx, kamaRvu ajAcnxnavanunx nAshapaDisuvudilalxveMbudu parxsidadhxveV, katatxlallx huTiTXkoMDiruva katatxleyaMtiruva I kamaR(ajAcnxnavanunx\break kaLeyuvudilalx).
\end{artha}
...
\begin{artha}
matutx kAmayxRkamaRgaLiMda mukitxyo? athavA nitayxkamaRgaLiMdaloV, athavA elAlx kamaRgaLiMdalU mukitxyo? matutx shwrxtakamaRgaLiMdaleV mukitxyo? athavA sAmxtaRkamaRgaLiMdaleV, athavA eraDu kamaRgaLiMdalU mukitxyo? eMdu vikalapx\break mADabeVkAgide. 
\end{artha}
...
\vishaya{75. samucacxya pakaSxnirAkaraNe \mdash aMgAMgiBAva samucacxyavu bAradu}
...
\begin{artha}
moVTumaravanunx kaLaLxneMba budidhxyiMda tiLidu hedarikoMDavanu heVge ODihoVguvano, hAgeye budidhxmuMtAdavugaLa\break rUpadalilx Atamxnanunx Barxmisidavanu ilalxdadxnunx AroVpisi\break vayxvaharisuvanu.
\end{artha}
...
\vishaya{adu EtakAkxgi eMdare \mdash}
...
\vishaya{athARsakitxparxmANadiMda moVkaSxvanunx kalipxsuvudakekx Aguvudilalx \mdash}
...
\vishaya{kamaRPalagaLu anaMtavAgalu beVrekAraNavU ide \mdash}
...
\begin{artha}
hiMde nitayxkamaRvu viSa dadhi modalAdavugaLaMte kAyARMtaravanunx utApxdisuvudeMdu heVLidUdx saha tananx viSayadalilx\break irabahudu.
\end{artha}
...
\begin{artha}
Atamxna saMsAkxrakAkxgiyeV yAvanu shAsatxrXdalilx heVLidaMte kamaRvanunx mADuvano, avananeVnx manuvu AtamxyAjiyeMdu\break heVLiruvanu.
\end{artha}

\vishaya{I aBipArxyakekx manuvacanada udAraNeyide \mdash}
...
\vishaya{muniyu ashavxmeVdhayAgamADidavarige sadagxtiyanunx heVLuvudakAkxgi horaTu modalu BuvanakoVshada aLateyanunx heVLuvaru \mdash}
...
\vishaya{`ayaMloVkaH' eMbudanunx vAyxKAyxnisuvaru \mdash}
...
\vishaya{A loVkaveV pArxNigaLa BoVga BUmiyAgide \mdash}
...
\vishaya{aloVkada savxrUpavanunx heVLutAtxre \mdash}
...
\vishaya{`ayaMloVkaH' eMbudara athaR \mdash}
...
\begin{artha}
A loVkakikxMta parimANadalilx paqthiviyu divxguNavAgiruvudu. adara sutatxlU eraDaraSuTx doDaDxdAgi samudarxvu paqthiviyanunx\break sututxvaredide.
\end{artha}
...
\vishaya{``iMdarxH parameVshavxraH yoV\s shavxmeVdheV\s ninxshicxtaH supaNoR yadivxSayaM\-\break dashaRnamukatxmf" eMba BASayxdalilx aginxshabadxda athaRvanunx\break heVLuvaru \mdash}
...
\vishaya{hAgAdare shariVvuLaLxvAyuvU. shariVraveMba apUvaRvU BinanxvAdadx\-riMda yAvudAdarU oMdakekx Palavanunx koDuva sAmathayxRviruvAga eraDu Etakekx? eMdare \mdash}
...
\vishaya{'vAyureVvavayxSiTxH vAyuH samaSiTx' eMbudara athaR \mdash}
...
\vishaya{(pArxNa)vAyuvina parxshaMsege PalaveVneMdare \mdash}
...
\vishaya{`apapuna maqRtuyxMjayati ya EvaMveda' eMbudara athaR \mdash}
