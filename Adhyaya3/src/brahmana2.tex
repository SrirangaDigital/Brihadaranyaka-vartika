...
\begin{artha}
jAcnxnakamaR samucacxyada PalaveMdu yAvudanunx hiMde heVLididxtoV (A hiraNayxgaBaR padaviyU saha) garxha-atigarxhagaLeMba baMdhanadiMda badadhxveV\break Agiruvudu.
\end{artha}
...
\begin{artha}
hiraNayx gaBaRnalUlx0 vAkukx, manasusx, pArxNa I rUpagaLu mUru ananxsavxrUpa\-dalUlx saMBavisuvudariMda garxha, atigarxha savxrUpagaLU adaralilx saMBavisuvudariMda ivugaLiMda parxjApatiyu mukatxnAgilalx.
\end{artha}
...
\begin{artha}
Atamxna nijasavxrUpavanunx yathAthaRvAgitiLida puruSanu yAvAga\break sAyuvano. AvAga ivananunx 
...
\begin{kandikeshl}
yAjacnxvalekxyXVti hoVvAca yatArxyaM puruSoV mirxyata\break udasAmxtApxrXNAH kArxmanAtxyXhoV3 neVti neVti hoVvAca\break yAjacnxvalokxyXV\s terxYva samavaniVyanetxV sa ucaCxvXyatAyxdhAmxyatAyxdhAmxtoV maqtaH sheVteV || 11 ||
\end{kandikeshl}
...
\begin{artha}
pArxNagaLu utAkxrXMtihoMduvudilalxvAdare Itanu sAyuvudeV ilalx\-\break veMdAguvudeMdu shaMkemADidare \textbf{utatxra}- sAvu eMbudu \textbf{shariVrakekx}, I riVtiyAgi jiVvanu eMdigU sAyuvududilalx. 
\end{artha}
...
\begin{artha}
putarxkeSxVtarx muMtAdavu nAmamAtarxvAgi uLiyuvudeMdu heVLuva lwkika vAkayxdalilx savxlapxvU uLiyuvudilalxveMdu heVge toVruvudo, hAgeye\break sAyuvAga nAma mAtarxve jAcnxniyanunx biDuvudilalx veMdare EnU uLiyavudilalxveMdu athaRvAguvudu.
\end{artha}
...
\begin{artha}
adariMdaleV puruSAthaRvu samApatxvAgiruvudariMda shAsatxrXvu kaqtAthaRvenisi hiMdakekx tiruvudu, adariMda adevxYta dashaRnadiMda EnoMdu\break parxyoVjanavU ilalx.
\end{artha}
...
\begin{artha}
pariceCxVdavanunxMTu mADuva vijAcnxnaveV avideyxyu, yAvudariMda\break paramAtamxnige 
...
\footnote{ananxmayarUpanAda sUtArxtamxnanunx soV\s haM eMdu ahaMgarxhoVpAsane mADidavanige yAva deYvavAda vAgAdigaLu jagadUrxpanAda sUtArxtamxna rUpavAgiruvavo avugaLa lABaveV\break deYvavAgAdi saMpatitxyeMbudara athaR, ``paqthiveyxY ceYnamf" itAyxdi shurxtiyiMda idu ukatxvAgide, ``sA ca nakiVSxyateV\s theYna meVteV deYvAHpArxNA amaqtA AvishasiVtx" eMba shurxtiyiMda jagatutx akaSxyaveMdu sidadhxvAguvudu.}deYvavAgAdisaMpatitxsatxthA tarxyXnAnxtamxdashiRnaH \hfill || 73 ||
\end{shl}
...
\begin{artha}
adariMda pUNaRvAda sUtArxtamxna savxrUpalABadiMda kAmakamaRgaLu\break kaSxyisuvudilalx, adara viSayadalilx parxmANavu saMBavisuvudilalx, adariMda idu sariyalalx.
\end{artha}
...
\begin{artha}
ajAcnxnakUkx idadxvasutxvanunx anusarisuva savxBAva videyeMbudu saMmatavAgidadxre ajAcnxnada viSayavanunx adanunx biTiTxruvudAdare yAvAgalu\break biTeVTxyiruvudeMdu heVLabeVku. adu aMTikoMDeVyiruvudAdare\break yAvAgalU viSayasaMbaMdhaviraleVbeVkAguvudu.
\end{artha}
...
\vishaya{ajAcnxniya vAgAdi iMdirxyagaLige layavilalxvAdadxriMda ``agiMvAgapeVyxti\break vAtaMpArxNaH" eMdu heVLidudx heVge saMgataveMdu parxshinxsidare\ndash }
