...
\begin{artha}
paqthiviyiMda AraMBisi AkAsha payaRMta iruva padAthaRgaLige eSuTx kAladavarege EkAtamxrUpavu heVLalapxDuvudilalxvo aSuTx kAladavaregU\break `yatAsxkASxtf' itAyxdi parxshenxya athaRvu niNaRyavAgade hoVguvudu.
\end{artha}
...
\begin{artha}
hiVge kaMDideyAdadxriMda gAgiRyu anumAnadiMda mahAjAcnxniyAda yAjacnxvalakxranunx kuritu parxshenxyanunx  keVLiruvaLu, adeVneMdare `yadidamf' eMba riVtiyalilx anumAnakekx upayukatxvAda vAyxpitxyanunx heVLutAtxre-
\end{artha}
...
\begin{artha}
`aMtarikaSxloVkeVSu ' eMdu bahuvacanavu (loVkaracanege beVkAda)\break upAdAnakAraNagaLu aneVkavAgiruvudariMda ililx garxhisalapxTiTxde, EkeMdare\break Atamxnanunx biTuTx elalxvU paMcaBUtagaLa savxrUpaveMbudanunx veVdAMtajacnxru tiLidirutAtxre.
\end{artha}
...
\begin{artha}
\footnote{savaRtaH parimaMDalAH eMdare elAlx kaDeyalUlx kuMThitavAgade iruva gatiyuLaLxvaru. (AnaM-TiVkA)}sUyaRna ratha saMcAravanunx mUvatetxraDariMda guNisidudx baruvaSuTx parimANavuLaLxdedxMdu hiMde yAvudanunx heVLididxto, adara saMniveVshadalilx iMdarx payaRMta iruva deVvategaLu niMtiruvaru.
\end{artha}
...
\begin{artha}
I riVtiyAgi Ota porxVta rUpadalilx I loVka nimARNavanunx barxhAmxMDa payaRMta vAyxKAyxnisidAdxyitu. inenxVnu uLidide? (aMdare barxhAmxMDakekx\break meVlalxTiTxdadxnunx takaRdiMda keVLabAradeMdathaR)
\end{artha}
...
\begin{artha}
sUthxlaviSayagaLanunx anumAna parxmANadiMda sevxVceCxyAgi keVLuvudu sari, I deVvateyAdaro sUthxlavalalx, yAva deVvateyanunx niVnu parxshinxsuveyo adu sUthxlavalalx.
\end{artha}
