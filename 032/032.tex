...
\vishaya{`akaqtABAyxgama{\rm --} itAyxdi BASayxda athaR{\rm --}'}
...
\vishaya{`kAvARseV rakatxtA yathA' eMdu heVLida daqSATxMtavu yukatxvalalx{\rm --}}
...
\vishaya{savxBAvavu biTuTxhoVdarU shudadhxteyu sididhxsuvudariMda Akalapxneyu yukatxve? eMdu keVLidare{\rm --}utatxra}
...
\vishaya{sidAdhxMtadalUlx I doVSasAmayxshaMkeyanunx pariharisuvudu \mdash  }
...
\vishaya{bwdadhxnu avayxBicAraveMbudegamakaveMbudanunx sahisade AkeSxVpisuvudu\mdash  }
...
\end{shl}
\footnotetext[1]{`pakeSxV sAdhayx nideVRshaH' parxtijAcnx eMdu tAkiRkaru heVLuvaMte parAthARnumAnadalilx sAdhayxsaMshayaviruva pakaSxdalilx sAdhayxvanunx nideRVshisuvudeV parxtijecnxyeMbuda athaR. udA:-`pavaRtoVvahinxmAnf' eMbuvaMte `dhUmavatAvxtf' eMdu paMcamayxMtapadavuLaLx vAkayxvanunx parxyoVgisuvudanenx heVtuvAkayxveMdu tiLiyabeVku athavA ``sAdhayxvatatxyA pakaSxvacanaM parxtijAcnx" `paMcamAyxnatxM liMgaparxtipAdakaM heVtuH | vAyxpitxparxtipAdakaM udAharaNamf |' `vAyxpitx vishiSaTx liMgaparxtipAdakaM vacanamu panayaH heVtu sAdhayxvatatxyA pakaSxparxtipAdakaM vacanaM nigamanamf' eMdu parAthARnumAna sathxLadalilx aidu avayavavuLaLx vAkayxvanunx parxyoVgisabeVku. idanunx ananxMBaTaTxru diVpikeyalilx heVLiruvaru. karxmavAgi udAharaNegaLu-1)pavaRtoVvahinxmAniti parxtijAcnxninxdhUmavatAvxditi heVtu, 3)yoVyoVdhUmavAnf soV\s ginxmAnf yathAmahAnasaH ituyxdAharaNaM tathAcAyaM pavaRto (vahinxvAyxpayx)gxdhUmavAnf  ituyxpanayaH tasAmxnf dhUmavatApxtf tathA  iti nigamanavf idaraMte svaRtarxtiLiyabeVku.}

%%footnote shloka
\begin{artha}
ililx pUvaRpakiSxyu hiVge heVLuvanu{\rm --}EneMdare? vijAcnxnavu huTiTxda mAtarxdiMdaleV pArxmANayxvu sididhxsuvudAdare parxtijecnxyoMdariMdaleV vAyxpaka jAcnxnavu sididhxsuvudariMda heVtuvanunx heVLuvudu vayxthaRvAguvudu.
\end{artha}
...
\vishaya{aneVka vasutxgaLalilxruvudeMba heVtuvu vaqkaSxtavxdalilx vayxBicaritavAdadxriMda savxBAvavalalxveMbukekx kAraNavalalxveMdu heVLidudx yukatxvalalx, alilx sAdhayxvU ideyeMdu shaMkisi utatxrisuvudu{\rm --}}
