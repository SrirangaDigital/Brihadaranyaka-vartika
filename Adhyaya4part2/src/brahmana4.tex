...
\vishaya{mumukuSxvu anAtamxvAcakavAda kamaRkAMDAdi shabadxciMteyanunx\break mADabAradu eMbudakekx beVre shurxtiyanunx adhArisuvudu\ndash }
...
\vishaya{paramAtamxneV shAsakanAgidadxre `seVtu' eMbapadavanunx Etakekx\break parxyoVgiside? eMdare}
...
\vishaya{vividiSAvAkayxvanunx parAmashiRsuvudariMdalU I athaRvu\break sididhxsuvudu\ndash } 
...
\vishaya{``tameVtaM veVdAnuvacaneVna barxhamxcayeRVNa bArxhamxNAvividiSanitx\break yajecnxVna dAneVna tapasA\s nAshakeVna' eMbudAgi mAdhayxMdina shAKeya pATha}
...
\vishaya{inunxmuMde ``EtadadhxsamxveY" itAyxdi vacanavanunx vAyxKAyxnisalu\break avataraNike AraMBavAgide}
...
\vishaya{meVlina viSayakekx ``vijAcnxna samAna kataqRkatovxVpadeVshAtf"\break itAyxdinA\s voV cAma|veVdAnu vacanAdinaha pAThAcacx itAyxdiBASayxvanunx yoVjisutAtxre}
...
%%footnote shloka
\begin{artha}
beVre parxkaraNadalUlx saMnAyxsa vidhiyanunx kalipxsuvudAdare ililxye (vidAyxparxkaraNadalelx) I vidhiyanunx samathiRsabahudu. BUmi\-\break yalilxyeV jeVnu sikukxvudAdare tiLidavanu yArutAne pavaRtakekx hoVguvanu? alalxde `parxvarxjanitx' eMdu saMnAyxsa vidhiyu laBisuvAga beVre parxkaNadalilx adanunx vidhisuvudakekx sharxma veVke?
\end{artha}
...
\vishaya{Eke kANamodalAda aMgavikalarige saMnAyxvu anuSeThxVyavAgi\break tiLidilalx?}
...
\vishaya{gwtamaru `aikAsharxmAyxMtAvxcAyARH' eMdu oMdeV oMdu\break gaqhAsAthxsharxmaveMdu heVLiruvAga saMnAyxsAsharxmavanunx heVge vidhisuvudu? eMdare}
...
\vishaya{pApavu tApavanunxMTumADuvudAdarU puNayxvu heVge tApa\-\break vanunxMTumADiVtu? hiVgAdare puNayxvu barxhamx jAcnxniyanunx saMkaTapaDisuvudilalxveMdu heVLidudx heVge? adu parxsakatxveV alalxvaSeTx? eMdu keVLidare-}
...
ESanitoyxVmahimA bArxhamxNasayx na vadhaRteV kamaRNA noV\break kaniVyAnf. taseyxYva sAyxtf padavitatxM viditAvx na lipayxteV kamaRNApApakeVna' (baq.a-4-4-23)}
...
\vishaya{``nitoyxV mahimA" eMbuva visheVSaNadiMda tAyxjAyxMshaveVnu?\break eMdare?}
...
\vishaya{savaRkamaRsaMnAyxsiyAdavanige shamAdiguNagaLu baruvaveMdu\break heVLutAtxre}
...
\vishaya{`uparataH' shurxtiyu nitayxkamaRtAyxgarUpavAda athaRvuLaLxdedxMdu\break heVLida meVlU paramatadaMte AkeSxVpa samAdhAnagaLanunx muMde etitx heVLutAtxre}
...
\vishaya{kamaRgaLu aviveVkadiMda AgiveyeMbudariMdaleV saMnAyxsavanunx\break mADaleVbeVkeMdu heVLutAtxre}
...
\vishaya{ajAcnxnaniderxyiMda mumukuSxgaLu ededxVLabeVkeMdu shurxtiyu\break ecacxrisutatxde}
...
\vishaya{`savaRMpApAmxnaMtapati' eMba vAkayxvanunx AkAMkASxpUvaRkavAgi\break vAyxKAyxnisutAtxre}
...
\vishaya{ESa eMdu anuvadisi barxhamxloVka shabadxvanunx parxyoVgisiruva\break udedxVshaveVnu?}
