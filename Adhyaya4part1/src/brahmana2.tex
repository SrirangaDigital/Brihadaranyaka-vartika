...
\begin{artha}
janaka rAjanu AsanadiMda keLagiLidu vidhivatAtxgi yAjacnxvalakxyXra baLige baMdanu matutx Bagavanf tamage iSaTxvAdadadxnunx nanage upadeVshisi eMdu keVLidanu.
\end{artha}
...
deVvoV BUtevxVti vacasA tatakxsAmxdiha paqcaCxyXteV \hfill || 10 || 
\end{shl}
...
\begin{shl}
iti vAyxcakaSxteV keVcidagxrXnathxmeVtaM mahAdhiyaH |\\
...
\begin{artha}
gati, gaMtavayx, ganatxqq (mAgaR hoVguva sathxLa, hoVguvava) eMbudeV modalAdavu OtaporxVta rUpavAda mAgaRdalilx\break barxhamxsavxrUpadalelxV mugidiruvudariMda paramAtamxnalilx mAgaR\break yAvudu tAne ide?.
\end{artha}
...
\begin{artha}
hiMde heVLida upAsaneya beMbaladiMda adhAyxtamx modalAda alapxsAthxnadiMda biDugaDe hoMdutAtx niVnu ililxMda elilxge hoguve eMbudanunx nanage shiVGarxvAgi heVLu.
\end{artha}
...
\begin{shl}
dakiSxNeV\s kiSxNXVnadhxnAmA\s yaM pumAnoBxVketxVti yaM viduH |\\
...
\vishaya{`tayoVreVSa saMsAtxvaH' eMbudara athaR \mdash}
...
\begin{artha}
AtamxnAdadxriMda tatavxvanunx Itanu hoMdiye iruvanu, Itanige deVshakAlAdigaLa vayxvadhAnavilalx, adariMda jAcnxnavanunx biTuTx savxsavxrUpavanunx hoMdalu matotxMdu sAdhanavoMdU beVkilalx.
\end{artha}
...
\begin{shl}
yatoV\s taH parxtAyxgAyxthAtamxyXBAsavxdivxjAcnxnaBAsakxraH |\\
...
\begin{artha}
yAva aBayarUpavAda dakiSxNe ide eMdu heVLito adeV tatavxjAcnxnaveMba dAnakekx yoVgayxvAdudu, adanunx biTuTx matotxMdu saMsAraveV Agiruvudu.
\end{artha}

\vishaya{yoVnoV itAyxdivAkayxda tAtapxyaR \mdash}
...
\begin{artha}
guruvu aBayavanunx koDuvavanAdadxriMda aBayavanunx tAnu hoMdiye iruvanaSeTx; hiVgiralu rAjanu guruvige `aBayaM tAvx' eMdu aBayavu tamage irali eMdu AshiVvARdavanunx koTiTxdudx heVge yukatx?.
\end{artha}
...
\begin{artha}
neVrA Aguva jAcnxnakikxMta beVrebeVroMdU mukitxge samathaRvAgilalx, eMbudu heVgo, hAgeye aneVka sala hejejx hejejxge hiMdeye heVLidedxVve.
\end{artha}
