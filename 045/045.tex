...
\begin{artha}
kAmaveMdare ililx yAva vAsanArUpavAda kAmagaLiveyo `mAhArajanamf' eMdu (mUtAR mUtaR bArxhamxNadalilx) heVLida vAkayxdiMda Atamxna\footnote[1]{``yathAhuH kAmAH punamARhArajanAdirUpAH'' eMdu BataqRparxpaMcaru.} shoVdhanegAgi heVLalapxTiTxveyo avugaLu ililx heVLalapxDuvudu.
\end{artha}
...
itAyxdi shurxtiyu\footnote[2]{adhAyxtamx adhiBUta adhideYvaveMbudAgi
...
keDisalapxTiTxlalx \footnote[1]{`ananAvxgataM puNeyxVna ananAvxgataM pApeVna tiVNoVR hi tadA Bavati' eMba shurxti.}ananAvxgata vAkayxdiMdalU
hAgU \footnote[2]{`asaknogxVhayxyaM puruSaH' eMbudeV shurxti.}asaMga shurxtiyiMdalU tiLidubaruvudu.
\end{artha}
...
beVreyAgiveyeMbudanunx nAnu hiMdeyU heVLidedxnaSeTx.\footnote[2]{haqdayalilx huTaTxde idadx athavA naSaTxvAda kAmagaLU
...
\begin{artha}
ideV\footnote[1]{vAtiRkada Adi padadiMda mUru rAshiyanunx kalipxsuvudu
...
\begin{artha}
\footnote[1]{sapaRvu poreyanunx biDuvudu adu hutatxdoLage
...
biTiTxruvudu, \footnote[2]{sapaR daqSATxMtavu jAcnxnige sapaRvu heVge
...
\begin{artha}
alalxde \footnote[1]{CAMdoVgayxdalilx (2ne parxpAThakadalilx) nAma, vAkf,
...
\begin{artha}
barxhamx matutx Atamx ivugaLige `kaqSaNxH\footnote[2]{kaqSaNxH sapaRH
...
hAgeye\footnote[3]{`amAnitavx madaMBitavxmf ahiMsA kASxnitxrAjaRvamf'
