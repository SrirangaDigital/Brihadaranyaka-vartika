...
yatasatxvaroVdhAthaRM tasAmxtasxvaRvisheVSaNamf \hfill || 378 ||  
\end{shl}
...
kAmAnAmapi nAshaH sAyxdanxrXhAtigarxharUpiNAmf \hfill || 383 ||  
\end{shl}
...
jahi shaturxM mahAbAhoV kAmarUpaM durAsadamf \hfill || 387 ||  
\end{shl}
...
maqtirAtamxmatisatxsayx heVtuheVtUpamadaRnAtf \hfill || 390 ||  
\end{shl}
...
BAtAmxsharxyANAM kAmAnAM vinivaqtitxH PalaM hi tatf \hfill || 399 ||  
\end{shl}
...
AsharxyAdeVva janemxYvaM kAmAnAM haqdayAsharxyAtf \hfill || 401 ||  
\end{shl}
...
tatasxvaRM pArxNa EveVti saMjahAra shurxtiH savxyamf \hfill || 422 ||  
\end{shl}
...
savaRkAmAdivatanaM parxmANamiti ceVnamxtamf \hfill || 442 ||  
\end{shl}
...
vikalopxV\s payxtarx neYvAsitx na hi vasutx vikalapxteV \hfill || 444 || 
\end{shl}
...
parxtijAcnxyA\s \s ha yukitxM ca tajajxlAniti sAdarAtf \hfill || 445 ||  
\end{shl}
...
avAyxvaqtAtxnanugataM parxtayxknABxtarxsatatatxvXkamf \hfill || 447 ||  
\end{shl}
...
sa hi tasimxnayxtaH shakotxV loVkAgAnxyXdividhw yathA \hfill || 450 || 
\end{shl}
...
ajAgalasatxnaseyxVva parxmANAdavxnadhxmoVkaSxyoVH \hfill || 457 ||  
\end{shl}
...
shurxteVsatxdanapeVkaSxtAvxnAnxpeVkaSxyXM kaNaBuknaBxtamf \hfill || 464 ||  
\end{shl}
...
taterxYvA\s \s temxVti dhiVreVSA nA\s \s gamApAyuvasutxSu \hfill || 468 ||  
\end{shl}
...
icACxdeVshicxtatxdhamaRtAvxtakxmaRsathxtavxMM sunishicxtamf \hfill || 470 ||  
\end{shl}
...
saMBaveV vayxBicAreV ca tacacx sAyxtakxlavatasxti \hfill || 483 ||  
\end{shl}
...
visheVSaNasharxvAtakxlXqpitxneYRtayoVsatxdivxrudadhxyoVH \hfill || 486 ||  
\end{shl}
...
deVshAdimacaCxriVreVpamx na saMbanadhxsatxmoV vinA \hfill || 518 ||  
\end{shl}
