...
\vishaya{idakekx anukUlisuvaMte gwDapAdara vacanavU ide ---} 
...
\vishaya{jagatetxlalxvU ajAcnxtavAda Atamxna vivataRveMdare EnuPala  eMdare ---}
...
\vishaya{A parxyoVjana yAvudu ? eMdare ---}
...
\vishaya{avideyxya kAyaRvu yAvudeMdu heVLide ? eMdare ---}
...
\vishaya{anaMtara muMdina bArxhamxNa tAtapxyaRvanUnx heVLutAtxre. ---}
...
\vishaya{gAgayxRneV AcAyaRnalalxve ? eMdare - alalx - EkeMdare ---}
...
\vishaya{ajAtashaturx bArxhamxNavanunx Iga AraMBisuvaru ---}
...
iSaTxvalalxveVnu ? deVhakekx beVreyAgi jiVvanidAdxne (avaneV kataR, BoVkatx) eMbudu iSaTxvAgidadxre, adara sAdhanegAgi sharxmapaDuvudu vayxthaRveV sari ||
\end{artha}

\vishaya{savxpakaSxdalilx eraDu doVSavU ilalx - enunxtAtxre ---}
...
\vishaya{I kAshiVrAjanu ajAtashaturx heVge ? eMdare ---} 
...
\vishaya{I shaMkege obabxra samAdhAna ---}
...
\vishaya{sidAdhxMtadalilx sAvxBipArxyavanunx tiLisuvaru ---}
...
mADabeVDaveMdu heVLuva samxqqtiyU ide ---}
...
vidoyxVpadeVshavanunx mADabeVkeMdu heVLuvudakekx parxmANa ---}
...
\begin{artha}
naSATxshavx-dagadhxrathada nAyxyadaMte nAyxyavanunx avalaMbisi I gAgayxRnu mAnuSavitatx (dhana)diMda tuMbida matutx deYvacitatxdiMdalU (upAsaneyiMda) kUDiyU idadx rAjananenx Asharxyisi (barxhamxvanunx) heVLidanu ||
\end{artha}
...
\vishaya{8. `goVsahasarxM dadAmi' eMbudara aBipArxya ---}
...
heVLuveneMdu' bAyiMda ADida mAtarxkekxVneye nAnu IgaleV oMdu sAvira goVvugaLanunx koDuvenu.
\end{artha}
...
\vishaya{`mA mA' eMdu eraDu sala Eke niSeVdhisidudx ? eMdare ---}
...
gAgayxRnanunx kuritu (`hAgalalx hAgalalx, hAge heVLabeVDa' eMdu) mA mA 
eMbudAgi niSeVdhavanunx eraDAvatiR heVLidudx savxlapx 
bAdhitavAgideyeMbuva budidhxyiMdalU gAgayxRnu (nijavAda barxhamxvanunx) heVLade iruva kAraNadiMdalU eMdu tiLiyabeVku ||
\end{artha}
...
\vishaya{``atiSAThxH saveRSAM'' itAyxdi shurxtiya vAyxKAyxnavu ---}
...
\vishaya{upAsaneya eraDu guNagaLanunx viMgaDisuvadu ---}
...
\begin{artha}
caMdarxnalilx aBimAnisikoMDa pArxNarUpanAda Atamxnige niVreV oMdu 
bahubiLupAda vasatxrX, adariMda pAMDaravAsAH | eMdu (samaSiTx 
pArxNarUpavAda Atamxnu) heVLalapxTiTxruvanu, swmayx guNaviruva 
nimitatxdiMda soVmaneMdU, beLadiMgaLiMda caMdarxnu bahu 
parxkAshisuvavanAdadxriMda soVmaneV rAjaneMdU bArxhamxNarige rAjaneMdu heVLalapxTiTxruvanu. I riVtiyAgi (baqhatf pAMDaravAsa, soVma, rAja eMdu nAlukx guNagaLiMda kUDiruvaMte), upAsaneyanunx mADabeVkeMdu vidhiyanunx mADalu udedxVshisi shurxtiyu heVLiruvudu ||
\end{artha}
...
\vishaya{viduyxtitxna veYshiSaTxyX eMdare ---}
...
\vishaya{12. AkAshadalilx barxhomxVpAsane ---}

\vishaya{AkAsharUpavAda barxhamxnige `pUNaR, aparxvatiR' eMdu eraDu 
guNagaLanUnx shurxtiyalilx heVLide, adara vivaraNe ---}
...
\vishaya{13. 4neV payARyadalilx heVLidaMte ---}

\vishaya{vAyuveV barxhamxveMdu upAsane mADuvavanige mUru PalagaLeMdu 
heVLide shurxti, adanunx vivarisutAtxre ---}
...
\vishaya{14. aidaneV payARyadalilx aginx puruSoVpAsanege heVLida `viSAsahi' - eMba guNada athaR ---}
...
\vishaya{15. AraneV payARyadalilx ``ya EvAyamapusx puruSaH EtameV vAhaM barxhomxVpAseV'' eMdu heVLi upadeVshisida vAkAyxthaR ---}
...
\vishaya{16. eMTaneya payARyadalilx maMtArxthaRvanunx heVLuvaru ---}
...
eMba visheVSaNavu ukatxvAgide, adara athaRveVneMdare ---} 
...
divxtiVya, anapaga eMdu eraDu visheVSaNagaLu heVLalapxTiTxve. (11neV kaMDikeyalilx) avugaLa athaRveVneMdare ---}
...
\vishaya{18. beVre payARyada vAyxKAyxna ---}
...
\vishaya{19. koneya payARyada vAyxKAyxna ---}
...
udedxVshiside. ililx (kone payARyadalilx mAtarx) samasatx vasutxgaLa 
dhAyxnavanunx udedxVsha mADide. hAgAdareVneye gAgayxRna tAtapxyaR niNaRyavAguvudu, hoMduvudu ||
\end{artha}
...
\vishaya{kataRvayxvAdarU Enu ? eMdare ---} 
...
\vishaya{`tameVteYH' itAyxdi vAkayxda athaRvanunx heVLuvaru ---}
...
saMkaravAgidudxdadxriMda avugaLanunx biDisi tiLiyuvudu kaSaTxveV AguvudeMdu (malagidadxvana hatitxra hoVdadudx). 
\end{artha}

\vishaya{saMkaraveMbudu suSupitxyalilx ilalxve ? eMdare ---}
...
hesarugaLiMda ecacxrisidarU ecacxrAgalilalx aSeTx, aceVtanavAdadxriMdalalxveMdu shaMke ---} 
...
\vishaya{22. visheVSa niNaRyavu heVgeMdare ? ---}
...
\begin{artha}
adhAyxtamx modalAda elAlx jagatatxnunx cenAnxgi vAyxpisikoMDiruvudo 
adu, (cakarxda) aragoVlugaLu nABiyalilx (guMBadalilx) avalaMbisi 
iruvaMte eMdu daqSATxMtadiMda I pArxNavasutxvinalelx jagatetxlalx OtaporxVtavAgide (heNedukoMDide) (aMdare jagatitxge nABiyaMte AdhAravAgide) || 
...
\vishaya{AtamxnigiMta beVpaRTiTxruva matotxMdu visheVSavanunx 
BASayxdaMte heVLuvaru ---}
...
\begin{artha}
ninanx pakaSxdalUlx I riVti garxhaNa mADadiruva doVSavu samAnavalalxve 
? eMdu parxshinxsidare utatxra - I riVti doVSavilalx. (rAjanu heVLuva) Atamxnu samasatx (deVheVMdirxyagaLa samudAyadalelx) aBimAna mADikoMDiruvudariMda, I Atamxnige EkadeVshavAda (pArxNavoMdaralelx) ahaMkAra (nAnu eMba aBimAna) vilalxvAdadxriMdalU (hesaranunx garxhisalAgalilalx) 
\end{artha} 

\vishaya{adanenx daqSATxMtadiMda sAdhisuvaru ---}
...
\begin{artha}
beraLu, kAlu keY muMtAda shabadxgaLanunx heVLidalilx (A 
aMgagaLuLaLxvanu) ecacxrAguvudilalx. pUNaRdeVhadalilx aBimAnavuLaLxvaneV Atamx (rAjanige beVkAdavanu) EkadeVshadalilx aBimAnavanunx hoMdiruvavanalalx ||
\end{artha}
