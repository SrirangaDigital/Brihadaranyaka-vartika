...
\begin{artha}
paMcamAdhAyxyada koneyalilx `rAteVdARtuH parAyaNaM tadivxdaH tiSaThxmAnasayx' eMdu heVLidadxnenx ililx \footnote[1]{kamaRPalavanunx upasaMhAra mADalu modalina vAkayx, jAcnxnaPalavanunx upasaMharisalu eraDane vAkayx.}upasaMhAra mADuvudu.
\end{artha}

\vishaya{kUTasathx niviRkAra Atamxnige `anAnxda', `vasudAna' eMba visheVSAthaRvu heVge ? saMgata ? eMdare ---}
...
\begin{artha}
savxtaH sahajavAda tatavxvu ililx heVLalapxTiTxde, `anAnxdo vasudAnaH' eMba vAkayxdiMda ajAcnxnadiMda kalipxtavAda \footnote[2]{ajAcnxna kalipxtavAda tatavx mUlakAraNaveMdathaR.}tatavxvu heVLalapxTiTxde.
\end{artha}
...
\vishaya{hiMde heVLida daqSiTxyeMbuva upAsanege takakx PalaveMbudakekx giVteya udAharaNe ---}
...
\vishaya{padAthaRvanunx heVLabeVkAgilalxvAdare tAtapxyaRvanunx heVLiruvudariMda bArxhamxNavu ililxge mugiyuvudilalxve ? eMdare ---}
...
\vishaya{`yathAseYnadhxva GanaH' itAyxdi maMtarxda athaR ---}
...
\vishaya{`avinAshiV anuciCxtitxdhamAR' eMba eraDu padagaLa punarukitxyanunx pariharisuvudu ---}
...
\vishaya{``mAtArx\s saMsagaRsatxvXsayx Bavati'' eMba mAdhayxMdina shurxtiya athaR ---}
...
\vishaya{paDeyuva vasutxvinalilx BeVdavilalxveMdu sAdhisutAtx `saESaH' itAyxdi maMtarxda tAtapxyaRvanunx heVLutAtxre ---}
