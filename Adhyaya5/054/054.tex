...
\vishaya{matotxMdu kAraNavU ide {\rm --}}
...
\vishaya{saMkiSxpatxvAgi heVLida Palavanunx visatxrisutAtxre {\rm --}}
...
\vishaya{shurxtuyxkatxvAda Palavanunx Iga heVLuvaru {\rm --}}
...
upasaMharisuva udedxVshaveVnu? eMdare {\rm --}}
...
baruva Palavanunx heVLalu AraMBisidAdxre {\rm --}}
...
\vishaya{mUru vAkayxgaLa athaRvanunx upasaMharisuvaru {\rm --}}
...
shaMkeyanunx parihAra mADutAtx vAyxKAyxnisutAtxre {\rm --}}
...
\footnotetext[1]{`suKAnushAyiVrAgaH' eMdu heVLide. `yadayxdidhx kuruteV kamaR tatatxtf kAmasayxceVSiTxtamf' eMba BArata 
...
\vishaya{`upayuRyxpari tapateyxVva' eMbudara athaR {\rm --}}
...
\vishaya{`neYSA gAyatirxV' itAyxdi maMtarxda tAtapxyaR {\rm --}}
...
\vishaya{kaNuNx satayxvAdare parxkaqta PalitAMshaveVnu? aMdare {\rm --}}
...
\vishaya{`tadevxYtatf satayxM' - itAyxdi vAkayxda athaR {\rm --}}
...
Aditayxnanunx aginxyeMdU upAsanegoVsakxra viMgaDisi heVLuvudu {\rm --}}
...
\vishaya{`EvamevxVSA gAyatirxV' - itAyxdi vAkayxda tAtapxyaR {\rm --}}
...
\vishaya{`sayAmeVva' itAyxdi vAkayxda tAtapxyARthaR {\rm --}}
...
\vishaya{tAmitAyxdi vAkayxda tAtapxyaR {\rm --}}
...
\vishaya{meVlina maMtarxda pUvARdhaRvanunx viMgaDisi anavxyisuvaru {\rm --}}
...
\vishaya{pUvaRpakaSx adeVnu nAyxya eMdare {\rm --}}
...
\vishaya{yadi havA itAyxdi vAkayxda tAtapxyaR {\rm --}}
...
visheVSavAgiyU heVLalu AraMBisidAdxre {\rm --}}
...
\vishaya{beVre tAtapxyaRvU ide {\rm --}}
...
\vishaya{I shurxtiyanunx Iga vAyxKAyxna mADuvudu {\rm --}}
...
\vishaya{`atha yAvatiVyaM tarxyiV vidAyx yaHsAtxvatf parxtigaqNiVhxyAtf' itAyxdi maMtarxda vAyxKAyxnavu {\rm --}}
...
\vishaya{`AthAsAyx EtadeVva turiVyaMdashaRtaM padamf' eMbudara tAtapxyaR {\rm --}}
...
\vishaya{`asAvadoVmApArxpatf kAmoV\s semxY mA samaqdidhx aha madaH pArxpayf' eMba maMtarxgaLanunx anavxyisutAtxre {\rm --}}
...
\vishaya{oMdeV upasAthxnakekx eraDu virudadhxvAda PalagaLu heVge? eMdare {\rm --}}
...
\vishaya{tanagAgi upasAthxna mADuvalilx I Palavu {\rm --}}
...
\vishaya{`yadihavA api bahivxvAgwnx aBAyxsadhati savaRmeVva tatasxMdahateyxVva' itAyxdi Palashurxtiyanunx yoVcisutAtxre {\rm --}}
...
\vishaya{`pUtoV\s jaroV\s maqtaH saMBavati' - eMbudara athaR {\rm --}}
...
deVvategaLa upasAthxnavanunx muMde heVLalu AraMBiside {\rm --}}
...
\vishaya{meVlina upasAthxna maMtarxda akaSxra vAyxKAyxna {\rm --}}
...
\vishaya{`tatatxvXM pUSa nanxpAvaqNu' - itAyxdi maMtarxda vAyxKAyxna {\rm --}}
...
\vishaya{`satayx dhamARya' itAyxdi vAkayxda vAyxKAyxna {\rm --}}
...
nAlukx saMboVdhana padagaLanunx vAyxKAyxnisuvudu {\rm --}}
...
\vishaya{`vUyxharashimxnf - itAyxdi maMtArxthaR {\rm --}'}
...
\vishaya{`yoV\s sAvasaw' - itAyxdi maMtarxda athaR {\rm --}}
...
\vishaya{`vAyu ranilamf' itAyxdi maMtarxda athaR {\rm --}}
...
\vishaya{Iga aginxya upasAthxnavanunx heVLuvaru {\rm --}}
...
\vishaya{OMkarxtoVsamxra kaqtaMsamxra eMbudara vAyxKAyxna {\rm --}}
