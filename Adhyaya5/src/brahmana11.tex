...
\begin{artha}
javxrAdi vAyxdhiyiMda roVgagarxsatxnAgi saMtapisuvudeMbudu\break yAvuduMTo; adoMdu utatxma tapasesxMdu paramaloVkavanunx bayasuvavanu ciMtisabeVku.
\end{artha}
...
\vishaya{`EtadevxY paramaMtapaH' itAyxdi vAkayxda tAtapxyaR \mdash }
...
\begin{artha}
yAvudakekx yAva yAvudu yoVgayxvAda PalavAguvado AyAya Palavanunx `ESa loVkaM jayati' eMba loVka padadiMda heVLiruvudu, tapasisxgU, tApasanigU aginxparxveVshakUkx yAva PalavideyoV adeV (ililx heVLida upAsanegaLige oMdoMdakUkx\break Aguvudu).
\end{artha}
...
%~ {\bf aidane adhAyxyadalilx hanonxMdane bArxhamxNavu}
